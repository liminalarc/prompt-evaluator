...
- **4.4** Organization management (admin) — list / create / rename / delete orgs — `IN PROGRESS` — [detail](specs/4.4.md)
- **4.5** Org-owner member management on the org page (owner-scoped) — `NOT STARTED` — [detail](specs/4.5.md)
